...
echo ""
echo "  PostgreSQL"
echo "    kubectl rollout restart deployment/hiteen-postgres -n hiteen"
echo "    # 또는"
echo "    kubectl delete pod -l app=hiteen-postgres -n hiteen"
echo ""
echo "  MongoDB"
echo "    kubectl rollout restart deployment/hiteen-mongo -n hiteen"
echo "    kubectl delete pod -l app=hiteen-mongo -n hiteen"
echo ""
echo "  Redis"
echo "    kubectl rollout restart deployment/hiteen-redis -n hiteen"
echo "    kubectl delete pod -l app=hiteen-redis -n hiteen"
echo ""
echo "  Soketi"
echo "    kubectl rollout restart deployment/hiteen-soketi -n hiteen"
echo "    kubectl delete pod -l app=hiteen-soketi -n hiteen"
echo ""
echo "=========================================="
