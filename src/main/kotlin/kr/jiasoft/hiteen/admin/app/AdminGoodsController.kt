    ...
    suspend fun saveGoods(
        ...
        val res =  if (req.id == null) {
            ...
            val updated = origin.copy(
                goodsName = req.goodsName ?: origin.goodsName,
                brandCode = req.brandCode ?: origin.brandCode,
                brandName = req.brandName ?: origin.brandName,
                content = req.content ?: origin.content,
                contentAddDesc = req.contentAddDesc ?: origin.contentAddDesc,
                searchKeyword = req.searchKeyword ?: origin.searchKeyword,
                mdCode = req.mdCode ?: origin.mdCode,
                category1Seq = req.category1Seq ?: origin.category1Seq,
                category1Name = req.category1Name ?: origin.category1Name,
                goodsTypeCode = req.goodsTypeCode ?: origin.goodsTypeCode,
                goodsTypeName = req.goodsTypeName ?: origin.goodsTypeName,
                goodsTypeDetailName = req.goodsTypeDetailName ?: origin.goodsTypeDetailName,
                goodsImgS = sAsset?.uid?.toString() ?: origin.goodsImgS,
                goodsImgB = bAsset?.uid?.toString() ?: origin.goodsImgB,
                goodsDescImgWeb = req.goodsDescImgWeb ?: origin.goodsDescImgWeb,
                brandIconImg = brandAsset?.uid?.toString() ?: origin.brandIconImg,
                mmsGoodsImg = req.mmsGoodsImg ?: origin.mmsGoodsImg,
                salePrice = req.salePrice,
                realPrice = req.realPrice,
                discountRate = req.discountRate,
                discountPrice = req.discountPrice,
                goodsComId = req.goodsComId ?: origin.goodsComId,
                goodsComName = req.goodsComName ?: origin.goodsComName,
                validPeriodType = req.validPeriodType,
                limitDay = req.limitDay ?: origin.limitDay,
                validPeriodDay = req.validPeriodDay ?: origin.validPeriodDay,
                goodsStateCode = req.goodsStateCode ?: origin.goodsStateCode,
                status = req.status,
