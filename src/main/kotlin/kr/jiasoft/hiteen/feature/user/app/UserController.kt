...
class UserController(
    ...
    @Operation(summary = "프로필 이미지 등록", description = "여러 장의 프로필 이미지를 업로드합니다. 각 파일 업로드 완료 시점마다 780x966 썸네일을 비동기로 사전 생성합니다.")
    ...
    @Operation(summary = "프로필 이미지 단건 등록", description = "프로필 이미지를 1장 업로드합니다. 업로드 완료 시점에 780x966 썸네일을 비동기로 사전 생성합니다.")
