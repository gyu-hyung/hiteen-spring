...
class StudyController(
    ...
    ): ResponseEntity<ApiResult<StudyStartResponse>>
    = ResponseEntity.ok(ApiResult.success(studyService.startStudy(user, request)))
    ...
    ): ResponseEntity<ApiResult<StudyResponse>>
    = ResponseEntity.ok(ApiResult.success(studyService.completeStudy(user.id, uid)))
}
