...
COMMENT ON COLUMN polls.address IS '주소';
COMMENT ON COLUMN polls.detail_address IS '상세 주소';
COMMENT ON COLUMN polls.lat IS '위도';
COMMENT ON COLUMN polls.lng IS '경도';
